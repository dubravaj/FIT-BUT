 ...
 * @author koci
 *//*
public class HomeWork2TestTest {
    ...
    public void testWorkingPack2() {
        ...
        //pack2.put(s);
        Card c = factory.createCard(Card.Color.HEARTS, 13);
        c.turnFaceUp();
        ...
        CardStack pack4 = factory.createWorkingPack();
        System.out.println("velkost s: " + s.size());
        pack4.put(s.pop(s.get(0)));
        System.out.println("velkost p4: " + pack4.size());
        Assert.assertEquals("Pracovni balicek c. 2 obsahuje 1 karty.", 1, pack4.size());
        Assert.assertTrue("Vkladame jednoprvkovu odebranou mnozinu.", pack3.put(pack4));
    }    
}*/
